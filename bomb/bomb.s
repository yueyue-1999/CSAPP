...
0000000000400ee0 <phase_1>:
  400ee0:	48 83 ec 08          	sub    $0x8,%rsp #移动栈帧
  400ee4:	be 00 24 40 00       	mov    $0x402400,%esi #将0x402400存入%rsi
  400ee9:	e8 4a 04 00 00       	callq  401338 <strings_not_equal> #string相等返回0,第一个参数是输入的字符串，第二个参数是%rsi
  400eee:	85 c0                	test   %eax,%eax #看%rax是否是0                                                         
  400ef0:	74 05                	je     400ef7 <phase_1+0x17> % #如果是0，跳转
  400ef2:	e8 43 05 00 00       	callq  40143a <explode_bomb> #爆炸
  400ef7:	48 83 c4 08          	add    $0x8,%rsp #400ef7:移动栈帧                      
  400efb:	c3                   	retq                                                            

0000000000400efc <phase_2>:
  400efc:	55                   	push   %rbp
  400efd:	53                   	push   %rbx
  400efe:	48 83 ec 28          	sub    $0x28,%rsp #将%rsp-40
  400f02:	48 89 e6             	mov    %rsp,%rsi #将%rsp的值存入%rsi
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers>
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp) #如果%rsp的值为1，ZF=1
  400f0e:	74 20                	je     400f30 <phase_2+0x34> #如果ZF=1，跳转
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34> #炸弹炸了
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax #
  400f1a:	01 c0                	add    %eax,%eax #将%rax变为2倍
  400f1c:	39 03                	cmp    %eax,(%rbx) 
  400f1e:	74 05                	je     400f25 <phase_2+0x29> #%如果%rax=%rbx,则跳转
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx #%rbx=%rbx+4
  400f29:	48 39 eb             	cmp    %rbp,%rbx 
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b> #如果%rbx不等于%rax,则跳转
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40>
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx #将第二个元素放入%rbx
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp #将第七个元素放入%rbp
  400f3a:	eb db                	jmp    400f17 <phase_2+0x1b>
  400f3c:	48 83 c4 28          	add    $0x28,%rsp #%rsp=%rsp+28
  400f40:	5b                   	pop    %rbx 
  400f41:	5d                   	pop    %rbp
  400f42:	c3                   	retq   
...
0000000000400f43 <phase_3>:
  ...
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi #x/s进行查看，%d整数
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax
  400f5b:	e8 90 fc ff ff       	callq  400bf0 <__isoc99_sscanf@plt> 
  400f60:	83 f8 01             	cmp    $0x1,%eax 
  400f63:	7f 05                	jg     400f6a <phase_3+0x27> #(%rax)>=1
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a> #((%rsp+8)==7或者(%rsp+8)-7溢出)
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,x8) #使用x/w查看, 跳转到400fa6
  400f7c:	b8 cf 00 00 00       	mov    $0xcf,%eax #%rax的值为208
  400f81:	eb 3b                	jmp    400fbe <phase_3+0x7b> 
  400f83:	b8 c3 02 00 00       	mov    $0x2c3,%eax #rax的值为0x2c3
...
0000000000400fce <func4>:
  ...
  400fdd:	d1 f8                	sar    %eax #将eax算数右移一位
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx 
  400fe2:	39 f9                	cmp    %edi,%ecx
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24> #如果rcx<=rdi,则跳转到400ff2
  ...
  400ff9:	7d 0c                	jge    401007 <func4+0x39> #如果rcx>=rdi(signed),跳转到401007
...
000000000040100c <phase_4>:
  ...
  401010:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx #将rsp+12位置的值放入rcx
  401015:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx #将rsp+8位置的值放入rdx
  40101a:	be cf 25 40 00       	mov    $0x4025cf,%esi #输入是两个整数
  40101f:	b8 00 00 00 00       	mov    $0x0,%eax #rax的值为0
  401024:	e8 c7 fb ff ff       	callq  400bf0 <__isoc99_sscanf@plt> #读取两个整数
  401029:	83 f8 02             	cmp    $0x2,%eax 
  40102c:	75 07                	jne    401035 <phase_4+0x29> #rax的值为2
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)
  401033:	76 05                	jbe    40103a <phase_4+0x2e> #(rsp+8)位置的值为<=14
  401035:	e8 00 04 00 00       	callq  40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx #rdx的值为14
  40103f:	be 00 00 00 00       	mov    $0x0,%esi #rsi的值为0
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi #rdi的值为7
  401048:	e8 81 ff ff ff       	callq  400fce <func4>
  40104d:	85 c0                	test   %eax,%eax 
  40104f:	75 07                	jne    401058 <phase_4+0x4c> #调用func4后rax的值为0
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)
  401056:	74 05                	je     40105d <phase_4+0x51> #rsp+12位置的值为0
...
0000000000401062 <phase_5>:
  401062:	53                   	push   %rbx
  401063:	48 83 ec 20          	sub    $0x20,%rsp #将rsp减去32
  401067:	48 89 fb             	mov    %rdi,%rbx #将rdi的值放入rbx
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
  401071:	00 00
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp) #在rsp+24的位置放置canary
  401078:	31 c0                	xor    %eax,%eax #rax归为全0
  40107a:	e8 9c 02 00 00       	callq  40131b <string_length>
  40107f:	83 f8 06             	cmp    $0x6,%eax
  401082:	74 4e                	je     4010d2 <phase_5+0x70> #%rax的值为6，说明string的长度为6
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx #input对应的ascii码存入rcx，rcx=0x66 (是输入字符串的第i个字符)
  40108f:	88 0c 24             	mov    %cl,(%rsp) #rsp=6
  401092:	48 8b 14 24          	mov    (%rsp),%rdx #rdx=6
  401096:	83 e2 0f             	and    $0xf,%edx #rdx=6
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx #r对应的ascii码放入rdx，rdx=0x72
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)
  4010a4:	48 83 c0 01          	add    $0x1,%rax
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax
  4010ac:	75 dd                	jne    40108b <phase_5+0x29> #若rax=6，跳出循环
  ...
  4010c6:	e8 6f 03 00 00       	callq  40143a <explode_bomb> #4010ae-4010c6说明rsp+16位置存放了flyers
  4010cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
  4010d0:	eb 07                	jmp    4010d9 <phase_5+0x77>
  4010d2:	b8 00 00 00 00       	mov    $0x0,%eax #%rax的值赋值为0
  4010d7:	eb b2                	jmp    40108b <phase_5+0x29>
  4010d9:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
  4010de:	64 48 33 04 25 28 00 	xor    %fs:0x28,%rax #检查canary
  4010e5:	00 00 
...
00000000004010f4 <phase_6>:
  ...
  #这一段确保每一个整数都<=6且任意两个整数不相等
  40110b:	49 89 e6             	mov    %rsp,%r14 #r14中存储第1个整数
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d 
  401114:	4c 89 ed             	mov    %r13,%rbp #rbp中是第i个整数
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax
  40111b:	83 e8 01             	sub    $0x1,%eax
  40111e:	83 f8 05             	cmp    $0x5,%eax
  401121:	76 05                	jbe    401128 <phase_6+0x34> #rax<=5,否则会爆炸,此时rax的值代表第i个整数-1
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d 
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d
  401130:	74 21                	je     401153 <phase_6+0x5f> #如果r12d==6，跳转
  401132:	44 89 e3             	mov    %r12d,%ebx 
  401135:	48 63 c3             	movslq %ebx,%rax #将2位的rbx进行符号扩展到4位并传入rax
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax #将输入的第i个整数放入rax
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)
  40113e:	75 05                	jne    401145 <phase_6+0x51> #第一个整数和第i个整数不能相等
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx 
  401148:	83 fb 05             	cmp    $0x5,%ebx
  40114b:	7e e8                	jle    401135 <phase_6+0x41> #如果rbx<=5,跳转  
  40114d:	49 83 c5 04          	add    $0x4,%r13  
  401151:	eb c1                	jmp    401114 <phase_6+0x20>
  
  #将rsp每个位置的元素设置为7-ni
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi #将结束字符放入rsi,rsi=rsp+24
  401158:	4c 89 f0             	mov    %r14,%rax #rax的地址与rsp的地址相同
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx #rcx=7
  401160:	89 ca                	mov    %ecx,%edx #rdx=7
  401162:	2b 10                	sub    (%rax),%edx #rdx=7-第i个整数的值
  401164:	89 10                	mov    %edx,(%rax) #rax的值为7-第i个整数
  401166:	48 83 c0 04          	add    $0x4,%rax  
  40116a:	48 39 f0             	cmp    %rsi,%rax
  40116d:	75 f1                	jne    401160 <phase_6+0x6c> #只要rax没有达到rsp+24的位置，就一直向前走

  #ni=1,vi=0x603320;ni=2,vi=0x603310;ni=3,vi=0x603300;ni=4,vi=0x6032f0;ni=5,vi=0x6032e0;ni=6,vi=0x6032d0
  40116f:	be 00 00 00 00       	mov    $0x0,%esi #rsi=0
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx #rdx=(0x6032d8)
  40117a:	83 c0 01             	add    $0x1,%eax #rax=2
  40117d:	39 c8                	cmp    %ecx,%eax 
  40117f:	75 f5                	jne    401176 <phase_6+0x82> #将rdx向前移动8*(7-第一个整数-1)这么多
  401181:	eb 05                	jmp    401188 <phase_6+0x94>
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2) #(rsp+32+2*i)=rdx
  40118d:	48 83 c6 04          	add    $0x4,%rsi #rsi=rsi+4
  401191:	48 83 fe 18          	cmp    $0x18,%rsi 
  401195:	74 14                	je     4011ab <phase_6+0xb7>
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx #rcx=7-n1
  40119a:	83 f9 01             	cmp    $0x1,%ecx
  40119d:	7e e4                	jle    401183 <phase_6+0x8f> #如果7-第一个整数的值<=1,跳转
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax 
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx 
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>

  #(v1+8)=v2,(v2+8)=v3,(v3+8)=v4,(v4+8)=v5,(v5+8)=v6
  ...
  4011bd:	48 8b 10             	mov    (%rax),%rdx #rdx=(rsp+40)
  ...
  #要求是(v1)>=(v2)>=(v3)>=(v4)>=(v5)>=(v6).用x/s看(vi),进行排序，确定vi对应的ni,从而找出最终解
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax #rax=(vi+8)=v_(i+1)
  4011e3:	8b 00                	mov    (%rax),%eax
  4011e5:	39 03                	cmp    %eax,(%rbx) #比较v_(i+1)与vi的值
